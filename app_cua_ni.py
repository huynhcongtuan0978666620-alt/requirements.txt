...
def main():
    ...
    st.markdown("""<div class="banner-top">QUẢN LÝ DỊCH VỤ</div><div class="banner-top" style="text-align: left; justify-content: flex-start; padding-left: 20px;">Salon KIM HIỀN © 2026 V13</div>
