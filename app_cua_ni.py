...
<div style="text-align: center; border-bottom: 1px dashed {THEME_COLORS['border_input']}; padding-bottom: 15px; margin-bottom: 20px;">
    ...
    <div style="font-size: 12px; color: {THEME_COLORS['text_muted']}; margin-top:2px;">Số hoá đơn: {str(config.get_so_thu_tu_don(st.session_state.client, 'BaoCao')).zfill(2)}-vô tận</div>
</div>
