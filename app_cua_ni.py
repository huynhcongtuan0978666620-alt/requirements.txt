...
def generate_css_animations():
    ...
    <style>
        ...
        .bang-hieu-lktv {
            ...
            margin-bottom: 50px !important; padding: 12px 15px !important; border-radius: 8px !important; background: #ffffff !important; 
            box-shadow: 10px 2px 12px rgba(0,0,0,0.03) !important; border: 1px solid #f0f0f0 !important;
        }
