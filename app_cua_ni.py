...
THEME_COLORS = {
    ...
    "bg_card": "#32c739",           # Nền thẻ (card) hiển thị nội dung
    ...
    # --- Màu nhấn (Accents) ---
    "primary": "#e6d6aa",           # Màu chủ đạo (thường dùng cho nút bấm, icon chính)
...
def set_app_background(colors):
    ...
    <style>
    .stApp {{
        background: linear-gradient(to bottom, {colors['bg_app']}, #666539);
        background: linear-gradient(to bottom, {colors['bg_card']}, #000000);
