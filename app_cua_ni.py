...
<div style="text-align: center; font-size: 25px; font-weight: 900; border-bottom: 1px dashed {Config.THEME_COLORS['border_input']}; padding-bottom: 15px; margin-bottom: 20px;">
    <div style="font-size: 25px; font-weight: 900; color: {Config.THEME_COLORS['text_main']};">{settings.get('TenTiem', 'SALON KIM HIỀN')}</div>
    <div style="font-size: 14px; color: {Config.THEME_COLORS['text_secondary']}; margin-top:4px;">{settings.get('Diachi', '')}</div>
    <div style="font-size: 14px; color: {Config.THEME_COLORS['text_secondary']};">SĐT: {settings.get('SDT', '')}</div>
    <div style="font-size: 20px; font-weight: 800; color: {Config.THEME_COLORS['text_main']}; margin-top:10px;">HÓA ĐƠN DỊCH VỤ</div>
    <div style="font-size: 14px; color: {Config.THEME_COLORS['text_muted']}; margin-top:5px;">Mã số: {ma_hd}</div>
    <div style="font-size: 14px; color: {Config.THEME_COLORS['text_muted']}; margin-top:2px;">Số ĐH trong ngày: {count_orders_today()}</div>
</div>
