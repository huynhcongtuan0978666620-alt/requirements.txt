...
<div style="display: flex; justify-content: space-between; margin-bottom: 10px; font-size: 18px; font-weight: 900; color: #111;"><span>TỔNG CỘNG:</span> <span style="text-align: right; color: #56e8e6;">{t_khach_tra:,.0f}</span></div>
